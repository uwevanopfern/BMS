...
urlpatterns = [
    ...
    path('pending-bookings/<int:building_id>/', views.get_pending_bookings_of_building),
    path('confirmed-bookings/<int:building_id>/', views.get_confirmed_bookings_of_building),
    path('booking-details/<int:booking_id>/', views.BookingDetailAPIView.as_view()),
