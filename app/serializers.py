...
class BillingSerializer(serializers.ModelSerializer):
    class Meta:
        ...
        fields = (
            'id', 'tenant', 'building', 'invoice_no', 'ebm_receipt_create_on', 'sub_total', 'tax_rate', 'tax_amount',
...
class TenantSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = models.Tenant
        fields = (
            'id', 'room', 'tenant_names', 'tenant_tin', 'tenant_main_email', 'tenant_main_phone', 'payment_date',
            'payment_method', 'membership_type', 'membership_end_time', 'rental_amount', 'business_desc', 'roomID',
            'room_name', 'room_number', 'buildingAcronym', 'buildingID', 'all_billings', 'paid_bills', 'unpaid_bills')
